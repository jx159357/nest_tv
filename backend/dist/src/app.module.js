        ...
        imports: [
            ...
            typeorm_1.TypeOrmModule.forRootAsync({
                ...
                useFactory: (configService) => ({
                    ...
                    extra: {
                        connectionLimit: Math.max(parseInt(configService.get('DB_POOL_MIN', '5')), Math.min(parseInt(configService.get('DB_POOL_MAX', '50')), Math.ceil(process.env.DB_CONNECTION_LIMIT ? parseInt(process.env.DB_CONNECTION_LIMIT) : 25))),
                        acquireTimeout: parseInt(configService.get('DB_ACQUIRE_TIMEOUT', '60000')),
                        timeout: parseInt(configService.get('DB_QUERY_TIMEOUT', '60000')),
                        queueLimit: parseInt(configService.get('DB_QUEUE_LIMIT', '30')),
                        waitForConnections: true,
                        connectTimeout: parseInt(configService.get('DB_CONNECTION_CHECK_TIMEOUT', '30000')),
