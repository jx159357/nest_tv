...
import { MediaListResponseDto, MediaDetailResponseDto, ErrorResponse } from './dtos/media-resource-response.dto';
...
export class MediaResourceController {
  ...
  @ApiQuery({ name: 'type', description: '影视类型', example: 'movie', enum: ['movie', 'tv', 'variety', 'documentary'] })
  @ApiQuery({ name: 'quality', description: '视频质量', example: '1080p', enum: ['1080p', '720p', '480p', '360p'] })
