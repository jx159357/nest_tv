  ...
  <div class="local-video-upload">
    ...
    >
      <div class="upload-area__content">
        ...
        <!-- 文件大小限制 -->
        <div class="upload-area__size-limit">
      ...
      <div class="video-preview__header">
        <div class="video-info">
          ...
          <div class="video-info__meta">
            ...
            <span v-if="videoDuration" class="video-info__duration">{{ formatTime(videoDuration) }}</span>
          </div>
        </div>
      ...
      <div v-if="videoMetadata" class="video-metadata">
        <div class="metadata-grid">
          <div class="metadata-item">
            ...
            <span class="metadata-value">{{ videoMetadata.width }} × {{ videoMetadata.height }}</span>
          </div>
          <div class="metadata-item">
