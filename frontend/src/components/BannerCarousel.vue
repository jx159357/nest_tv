        ...
        <div class="slide-content">
          <div class="slide-info">
            ...
            <div class="slide-meta">
              ...
              <span v-if="item.releaseDate" class="meta-year">{{ new Date(item.releaseDate).getFullYear() }}</span>
...
const formatType = (type: string) => {
  const map: Record<string, string> = { movie: '电影', tv_series: '电视剧', variety: '综艺', anime: '动漫', documentary: '纪录片' };
