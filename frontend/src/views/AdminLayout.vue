<template>
  <div class="min-h-screen bg-gray-50">
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
          ...
          <div class="flex items-center space-x-4">
            ...
            <button @click="handleLogout" class="text-red-600 hover:text-red-900">
              退出登录
            </button>
          </div>
        </div>
    ...
    <div class="flex">
      <!-- 移动端警告 -->
      <div v-if="showMobileWarning" class="fixed inset-0 bg-gray-900 bg-opacity-50 z-50 flex items-center justify-center p-4">
        <div class="bg-white rounded-lg p-6 max-w-sm w-full text-center">
          <svg class="w-12 h-12 text-orange-500 mx-auto mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.035-1.666 2.035-3.657 0 1.337-.645 3.228-2.42 3.228-3.657z" />
          </svg>
          <h3 class="text-lg font-medium text-gray-900 mb-2">设备不支持</h3>
          <p class="text-gray-600 mb-4">后台管理功能需要在大屏幕设备上使用，请使用平板或电脑访问。</p>
          <div class="space-y-3 text-left">
            <div class="flex items-center text-sm text-gray-600">
              <svg class="w-4 h-4 text-blue-500 mr-2" fill="currentColor" viewBox="0 0 20 20">
                <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 7.293a1 1 0 01-1.414 0l-3-3a1 1 0 010-1.414l3 3a1 1 0 001.414 0z" clip-rule="evenodd" />
              </svg>
              建议屏幕尺寸：≥ 768px
            </div>
            <div class="flex items-center text-sm text-gray-600">
        ...
        <nav class="p-4">
          <ul class="space-y-2">
            <li>
              ...
              >
                <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7-7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v-3m0 0h-3m-6 0h3" />
                </svg>
                仪表盘
              </router-link>
            </li>
            <li>
              ...
              >
                <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292 0 4.465 4.465 0 00.702-.052l4.335-3.511c.287-.268.508-.767.508-1.251V6.5a.5.5 0 00-2.249-.83L9.876 2.69a.5.5 0 00-1.752 0L2.25 5.67A.5.5 0 000 6.5v7.656a5.5 0 001.752 0l4.335 3.511a.5.5 0 001.752 0L21.75 14.33a5.5 0 002.249-.83V6.5z" />
                </svg>
                用户管理
              </router-link>
            </li>
            ...
            <li>
              ...
              >
                <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707H19a2 2 0 012 2z" />
                </svg>
                系统日志
              </router-link>
            </li>
