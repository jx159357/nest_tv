      ...
      <header class="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
        <div>
          ...
          <p class="mt-2 text-sm text-gray-600">
            聚合你的观看、收藏、搜索和推荐画像，形成一个更完整的兴趣中心。
          </p>
        </div>
        ...
        <aside class="space-y-6">
          <section class="rounded-2xl bg-white p-6 shadow-sm">
            <div class="text-center">
              <div
                class="mx-auto mb-4 flex h-24 w-24 items-center justify-center rounded-full bg-slate-100 text-2xl font-semibold text-slate-500"
              >
                {{ getUserInitial() }}
              </div>
              ...
              <div
                class="mt-3 inline-flex rounded-full bg-indigo-100 px-3 py-1 text-sm font-medium text-indigo-700"
              >
                {{ authStore.user?.role }}
              </div>
            </div>
        ...
        <div class="space-y-6">
          ...
          <section class="rounded-2xl bg-white p-6 shadow-sm">
            <div class="flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
              <div>
                ...
                <p class="mt-2 text-sm text-gray-600">
                  把观看偏好、最近搜索和收藏内容放到一个视图里，方便快速回到感兴趣的方向。
                </p>
              </div>
              <router-link
                :to="{ name: 'recommendations', query: { focus: 'profile' } }"
                ...
                <div class="mt-4 space-y-3 text-sm text-slate-700">
                  <div>
                    ...
                    <div class="mt-2 flex flex-wrap gap-2">
                      <span
                        v-for="item in recommendationProfile.favoriteTypes"
                        :key="`type-${item.key}`"
                      ...
                      <span
                        v-if="recommendationProfile.favoriteTypes.length === 0"
                  ...
                  <div>
                    ...
                    <div class="mt-2 flex flex-wrap gap-2">
                      <span
                        v-for="item in recommendationProfile.favoriteGenres"
                        :key="`genre-${item.key}`"
                      ...
                      <span
                        v-if="recommendationProfile.favoriteGenres.length === 0"
                        class="text-slate-500"
                        >暂无明显偏好</span
                      >
                    </div>
                  ...
                  <div>
                    ...
                    <div class="mt-2 flex flex-wrap gap-2">
                      ...
                      <span
                        v-if="recommendationProfile.recentSearchKeywords.length === 0"
                        class="text-slate-500"
                        >暂无搜索兴趣</span
                      >
                    </div>
          ...
          <section class="rounded-2xl bg-white p-6 shadow-sm">
            ...
            <div v-else-if="continueWatching.length > 0" class="mt-6 space-y-4">
              ...
              >
                <div
                  class="flex h-16 w-16 items-center justify-center overflow-hidden rounded-xl bg-slate-200"
                >
                  <img
            ...
            >
              ...
              >
                ...
                <div class="mt-2 text-sm text-slate-500">
                  评分：{{ formatRating(item.mediaResource.rating) }}
                </div>
              </button>
            </div>
