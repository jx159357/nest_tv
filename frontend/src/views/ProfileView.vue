      ...
      <div class="grid-responsive">
        ...
        <div class="lg:col-span-3 space-y-6">
          ...
          <div class="card-responsive">
            ...
            <div v-if="statsLoading" class="text-center py-4">加载中...</div>
          ...
          <div class="card-responsive">
            ...
            <div v-if="continueLoading" class="text-center py-4">加载中...</div>
          ...
          <div class="card-responsive">
            ...
            <div v-if="completedLoading" class="text-center py-4">加载中...</div>
