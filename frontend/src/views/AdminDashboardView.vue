          ...
          <div class="flex items-center">
            ...
            <div class="ml-5 w-0 flex-1">
              <dl>
                ...
                <dd class="flex items-baseline">
                  <div class="text-2xl font-semibold text-gray-900">{{ stats.playSourceCount }}</div>
                </dd>
              </dl>
            </div>
          </div>
          ...
          <div class="flex items-center">
            ...
            <div class="ml-5 w-0 flex-1">
              <dl>
                ...
                <dd class="flex items-baseline">
                  <div class="text-2xl font-semibold text-gray-900">{{ stats.watchHistoryCount }}</div>
                </dd>
              </dl>
            </div>
          </div>
                    ...
                    <div :class="[
                      ...
                      <svg class="w-5 h-5" :class="[
                        ...
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" 
                              :d="log.status === 'success' ? 'M5 13l4 4L19 7' :
                                  log.status === 'error' ? 'M6 18L18 6M6 6l12 12' :
                                  'M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 3.035-1.666 3.035-3.657 0 1.337-.645 3.228-2.42 3.228-3.657z'" />
                      </svg>
                    </div>
                  </div>
                  <div class="min-w-0 flex-1">
                    <p class="text-sm font-medium text-gray-900">{{ getActionText(log.action) }} - {{ getResourceText(log.resource) }}</p>
                    ...
                    <p v-if="log.status === 'error' && log.errorMessage" class="text-sm text-red-600 mt-1">{{ log.errorMessage }}</p>
                  </div>
                </div>
              </li>
            </ul>
