            ...
            <tbody class="bg-white divide-y divide-gray-200">
              <tr v-for="playSource in playSources" :key="playSource.id">
                ...
                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                  ...
                  <div v-else class="text-gray-500">ID: {{ playSource.mediaResourceId }}</div>
                </td>
                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                  {{ playSource.type }}
                </td>
      ...
      <div class="bg-white rounded-lg max-w-2xl w-full max-h-screen overflow-y-auto">
        <div class="p-6">
          <div class="flex justify-between items-center mb-4">
            ...
            <button class="text-gray-400 hover:text-gray-500" @click="closeModal">✕</button>
          </div>

          <form class="space-y-4" @submit.prevent="savePlaySource">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div class="flex items-center">
                ...
                />
                <label class="ml-2 block text-sm text-gray-900"> 是否启用 </label>
              </div>
            </div>
